...
I am now going to transition to estimating dietary proportions in MixSIAR using the covariates as determined above. To begin, I clear my R environment except for the data files.


```{r}

rm(list = setdiff(ls(), c("BearDietSources", "bears.si")))
